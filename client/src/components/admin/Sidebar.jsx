...
const Sidebar = () => {
  return (
    <div className='flex flex-col border-r border-gray-200 min-h-full pt-6'>
      ...
      <img src={assets.home_icon} alt='' className='min-w-6 w-6'/>
      ...
      <img src={assets.add_icon} alt='' className='min-w-6 w-6'/>
      ...
      <img src={assets.list} alt='' className='min-w-6 w-6'/>
      ...
      <img src={assets.comment1} alt='' className='min-w-6 w-6'/>
