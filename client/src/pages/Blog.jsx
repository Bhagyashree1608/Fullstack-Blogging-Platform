...
function Blog() {
  ...
  return data ? (
    <div className='relative'>
         <img src={assets.gb}  alt='gradient' className="fixed inset-0 w-screen h-screen object-cover opacity-50 -z-10"/>
    <Navbar/>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-xl border-primary/35 bg-primary/5 font-medum text-primary'>Author:  {data.author}</p>
      </div>
