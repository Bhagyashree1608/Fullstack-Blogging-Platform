...
const AddBlog = () => {
  ...
  const editorRef = useRef(null);//reference variable for quill
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 min-h-full overflow-y-auto'>
      <div className='bg-white  w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded '>
       ...
       <label htmlFor="image">
        ...
        <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
          ...
          <button disabled={loading} type='button' onClick={generateContent} className='absolute bottom-1 right-2 ml-2 text-xs text-white bg-black/70 px-4 py-1.5 
      ...
      text-white rounded cursor-pointer'>{isAdding ? 'Adding....' :'Add Blog'}</button>
      </div>
    </form>
  );
}
