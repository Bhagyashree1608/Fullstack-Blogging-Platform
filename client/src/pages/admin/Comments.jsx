  ...
  return (
    <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      <div className='flex justify-between items-center max-w-3xl'>
         <h1 className="text-2xl font-semibold text-gray-800 mb-2">Comments</h1>
      ...
      <div className='relative max-w-4xl overflow-x-auto mt-4 bg-white shadow rounded-lg scrollbar-hide'>
       <table className='w-full text-sm text-gray-500'>
         <thead className='text-3xs text-gray-700 text-left uppercase'>
           <tr>
